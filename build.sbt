...
val refined = project
  ...
  .settings(publishSettings)
  .settings(libraryDependencies ++= Seq("eu.timepit" %% "refined" % "0.9.2"))
  .dependsOn(core)
...
val dependencyDeclarationAlias = "undeclaredCompileDependenciesTest" :: "unusedCompileDependenciesTest" :: Nil
